...
def test_ability_instance():
    ...
    big_strength = sApocalypse Rail", 300)
    assert big_strength
...
# Test Heroes Class
def test_hero_instance()las = superheroes.Hero("Atlas")
    assert Atlas
...
def test_hero_multi_weapon_attack():
    ...
    Atlas.add_ability(sword_of_truth)
    assert len(Atlas.abilities) == 2
...
def test_hero_weapon_ability_attack():
    ...
    sword_of_truth = superheroes.Weapon("Apocalypse Rail", 700)
    Atlas = superheroes.Hero("Atlas")
    Atlas.add_ability(quickness)
    Atlas.add_ability(sword_of_truth)
    assert len(Atlas.abilitiesHolmes
