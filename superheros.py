...
class Arena(Hero):
    ...
    def create_ability(self):
        ...
        max_damage = input("What is the ability's maximum damage? ")
        return Ability(name, max_damage)

    def create_weapon(self):
        name = input("What is the weapon's name? ")
        max_damage = input("What is the weapon's maximum damage? ")
        return Weapon(name, max_damage)

    def create_armor(self):
        name = input("What is the armor's name? ")
        max_block = input("What is the armor's defensive power? ")
